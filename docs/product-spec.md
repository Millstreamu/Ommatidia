...
- **Dedicated component library page**: project drill-down includes `#/projects/:projectId/library` for component library browsing/search, while project overview keeps a compact library summary card.
