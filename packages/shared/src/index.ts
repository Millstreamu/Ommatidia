...
export const engineeringModuleSchema = z.object({
  id: z.string(), name: z.string(), description: z.string(), moduleType: moduleTypeSchema,
  applicableProjectTypes: z.array(z.string()), inputs: z.array(moduleInputSchema), outputs: z.array(moduleOutputSchema),
